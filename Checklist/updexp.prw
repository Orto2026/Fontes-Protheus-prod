...
aAdd( aSX6, { ;
	...
	'FS_DIRLG'																, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Diretorio dentro da pasta System onde se encontra'						, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'o logotipo da empresa para ser utilizado no'							, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	'relatorio de Pedidos de Venda'											, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	'Logo\LGORTO01.jpg'														, ; //X6_CONTEUD
	'Logo\LGORTO01.jpg'														, ; //X6_CONTSPA
	'Logo\LGORTO01.jpg'														, ; //X6_CONTENG
	'U'																		, ; //X6_PROPRI
	''																		, ; //X6_VALID
	''																		, ; //X6_INIT
	''																		, ; //X6_DEFPOR
