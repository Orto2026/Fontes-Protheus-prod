	...
	If QA6->(DbSeek(xFilial("QA6")+"INTERN"))
		While QA6->(!Eof() .AND. QA6_FILIAL+QA6_PLANO==xFilial("QA6")+"INTERN")
			If QA6->(nQtdInsp >= QA6_LOTINF .AND. nQtdInsp <= QA6_LOTSUP)
					...
					Do Case
						CASE QA6->QA6_CODAMO == "G"
							nQtdInsp := 13
							Exit
						CASE QA6->QA6_CODAMO == "H"
							nQtdInsp := 20
							Exit
						CASE QA6->QA6_CODAMO == "J"
							nQtdInsp := 32
							Exit
						CASE QA6->QA6_CODAMO == "K"
							nQtdInsp := 50
							Exit
						CASE QA6->QA6_CODAMO == "L"
							nQtdInsp := 80
							Exit
						CASE QA6->QA6_CODAMO == "M"
							nQtdInsp := 125
							Exit
						CASE QA6->QA6_CODAMO == "N"
							nQtdInsp := 200
							Exit
						CASE QA6->QA6_CODAMO == "O"
							nQtdInsp := 315
							Exit
						CASE QA6->QA6_CODAMO == "P"
							nQtdInsp := 500
							Exit	
					EndCase
					//iF !Empty(nQtdInsp)
