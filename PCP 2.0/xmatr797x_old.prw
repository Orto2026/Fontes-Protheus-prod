...
If _nRecurso $ "12025|12029"
	li += 5 //20
	_nPosLinha := li / 11.6
	oPrinter:FWMSBAR("CODE128" /*cTypeBar*/,_nPosLinha/*nRow*/,02.5/*nCol*/,AllTrim((_cAliasTop)->C2_PRODUTO)+"  "+AllTrim((_cAliasTop)->C2_LOTECTL)/*cCode*/,oPrinter/*oPrint*/,;
	/*lCheck*/,/*Color*/,/*lHorz*/,/*nWidth*/,0.5/*nHeigth*/,/*lBanner*/,/*cFont*/,/*cMode*/,.F./*lPrint*/,/*nPFWidth*/,/*nPFHeigth*/,/*lCmtr2Pix*/) 	
	oPrinter:Say(Li+37,070,+"PRODUTO | LOTE "+ AllTrim((_cAliasTop)->C2_PRODUTO) +" "+AllTrim((_cAliasTop)->C2_LOTECTL),oFontTB)
