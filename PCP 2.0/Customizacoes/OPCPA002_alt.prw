...
User Function PP002A01(n_Opcao,cNumOP,cAltOP,cLocal)
  ///User Function PP002A01(n_Opcao,c_OP,c_ProdDe,c_ProdAta,c_Unidade,nSelect)
	...
	Private _nExeOP := cAltOP
	Private _nLocal := cLocal
	Private _nNumOP := cNumOP
...
Static Function _fExecProd(n_Opcao)
	...
	If Empty(_aDadosOP)
		MsgAlert("Não existe dados para os parâmetros informados!" + CRLF+ CRLF +"OP :"+_cNumOpDe + CRLF + CRLF + "Verifique.")
	 Else
